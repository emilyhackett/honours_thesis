...
\DeclareAcronym{uwwls}{short=UW WLS,long=unwrapped phase with \ac{wls}}
\DeclareAcronym{uwsg}{short=UW SG,long=unwrapped phase with \ac{sg} filtering}
\DeclareAcronym{posg}{short=PO SG,long=phase offset with \ac{sg} filtering}
\DeclareAcronym{wfd}{short=WFD,long=weighted smoothing of \ac{fd}}
\DeclareAcronym{uwfd}{short=UWFD,long=unweighted smoothing of \ac{fd}}
\DeclareAcronym{pffd}{short=PF FD,long=pre-filtered smoothing of \ac{fd}}
